...
#define SAY_HELLO_SIZE (sizeof(say_hello_bin))

char test_page_fault_bin[]={
		#include "executables/test_page_fault.bin"
};
#define TEST_PAGE_FAULT_SIZE (sizeof(test_page_fault_bin))
...
dir_t bin_dir[] = {
   ...
   { 19, MODE_EXEC, SAY_HELLO_SIZE, "say_hello", (char *)say_hello_bin },
   { 20, MODE_EXEC, TEST_PAGE_FAULT_SIZE, "test", (char *)test_page_fault_bin },
