...
#define TERMINAL_MSG_LENGTH 101
#define DRAM_PAGE_COUNT 100
...
typedef struct {
	...
	int code[3]; //code[0] = STATUS ; code[1] = owner/FD; code[2] = # of bytes read;
} msg_t;
...
typedef struct {
        ...
        int owner; //the PID currently using the DRAM page
} DRAM_t;
